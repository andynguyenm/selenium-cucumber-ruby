...
* [Navigation Steps](https://github.com/andynguyenm/selenium-cucumber-ruby/blob/master/doc/canned_steps.md#navigation-steps)
* [Assertion Steps](https://github.com/andynguyenm/selenium-cucumber-ruby/blob/master/doc/canned_steps.md#assertion-steps)
* [Input Steps](https://github.com/andynguyenm/selenium-cucumber-ruby/blob/master/doc/canned_steps.md#input-steps)
* [Click Steps](https://github.com/andynguyenm/selenium-cucumber-ruby/blob/master/doc/canned_steps.md#click-steps)
* [Progress Steps](https://github.com/andynguyenm/selenium-cucumber-ruby/blob/master/doc/canned_steps.md#progress-steps)
* [Screenshot Steps](https://github.com/andynguyenm/selenium-cucumber-ruby/blob/master/doc/canned_steps.md#screenshot-steps)
* [Configuration Steps](https://github.com/andynguyenm/selenium-cucumber-ruby/blob/master/doc/canned_steps.md#configuration-steps)
* [Mobile steps](https://github.com/andynguyenm/selenium-cucumber-ruby/blob/master/doc/canned_steps.md#mobile-steps)
